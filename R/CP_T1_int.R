...
#'
#' This function computes the coverage probability using Theorem 4.5.1 and
...
#' }
#' We use \code{integrate()} function to compute the integrals.
#'
...
#'
#' @returns Coverage probability computed using Theorem 4.5.1 and \code{integrate()}
#' function.
#' @export
#'
#'
CP_T1_int <- function(gamma.vec, alpha, d, rho, t.vec,
  ...
  cp <- (1 - alpha) + ICP_T1_int(rho, d, alpha, gamma.vec,
