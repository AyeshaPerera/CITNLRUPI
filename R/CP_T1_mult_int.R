...
#' }
#' We use multiple \code{integrate()} functions to compute the integrals.
#'
...
#'
#' @returns Coverage probability computed using Theorem 4.5.1 and multiple
#' \code{integrate()} functions.
#' @export
#'
#'
